<template>
        ...
        <MenuButton
            class="flex w-full justify-center gap-x-1.5 rounded-md
        ...
        >
          ...
          >
            ...
            <div class="px-1 py-1">
              <MenuItem v-slot="{ active }">
                <a class="text-gray-700 block px-4 py-2 text-sm">New Project</a>
              </MenuItem>
              <MenuItem v-slot="{ active }">
                <a class="text-gray-700 block px-4 py-2 text-sm">New User</a>
              </MenuItem>
            </div>
          </MenuItems>
        </transition>
